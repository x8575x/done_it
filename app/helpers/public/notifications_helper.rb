  ...
  def notification_form(notification)
	 ...
	 # your_item = link_to 'あなたの投稿', users_review_path(notification), style:"font-weight: bold;"
	  ...
	  case notification.action
	    ...
	    when "dm" then
	    	tag.a(notification.visiter.name, href:user_path(@visiter))+"さんから"+tag.a('メッセージ', href:direct_message_path(@visiter))+"が届いています"+tag.p(DirectMessage.find_by(id: @visiter.direct_message_ids)&.message)
	  end
  end
